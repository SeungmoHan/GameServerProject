...
namespace univ_dev
{
	...
	public:
		...
		inline double TotalEthernetSendBytes() { return _NetworkSendBytes; }
		inline double TotalEthernetSendKBytes() { return _NetworkSendBytes / 1024; }
		inline double TotalEthernetSendMBytes() { return _NetworkSendBytes / 1024 / 1024; }

		inline double EthernetSendBytes() { return _NetworkSendBytesPerSec; }
		inline double EthernetSendKBytes() { return _NetworkSendBytesPerSec / 1024; }
		inline double EthernetSendMBytes() { return _NetworkSendBytesPerSec / 1024 / 1024; }

		inline double TotalEthernetRecvBytes() { return _NetworkRecvBytes; }
		inline double TotalEthernetRecvKBytes() { return _NetworkRecvBytes / 1024; }
		inline double TotalEthernetRecvMBytes() { return  _NetworkRecvBytes / 1024 / 1024; }

		inline double EthernetRecvBytes() { return _NetworkRecvBytesPerSec; }
		inline double EthernetRecvKBytes() { return _NetworkRecvBytesPerSec / 1024; }
		inline double EthernetRecvMBytes() { return  _NetworkRecvBytesPerSec / 1024 / 1024; }
	...
	private:
		...
		double _NetworkRecvBytesPerSec;

		double _NetworkSendBytes; // 총 Send Bytes 모든 이더넷의 Send 수치 합
		double _NetworkSendBytesPerSec;
	};
}

...
namespace univ_dev
{
	HardWareMonitor::HardWareMonitor(HANDLE hProcess) : _EthernetStruct{ 0 }, _Process(hProcess), _EthernetQuery(nullptr), _NonPagedPoolQuery(nullptr), _NetworkRecvBytes(0), _NetworkSendBytes(0), _NonPagedPoolBytes(0), _AvailableMemoryQuery(nullptr), _AvailableMemoryBytes(0)
	{
		//------------------------------------------------------------------
	...
	void HardWareMonitor::UpdateHardWareTime()
	{
		//---------------------------------------------------------
	// 프로세서 사용률을 갱신한다.
	//

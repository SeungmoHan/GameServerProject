...
namespace univ_dev
{
    ...
    struct Session
    {
        Session() : _SessionID(0), _SendBufferCount(0), _SendPacketBuffer{ 0 }, _Sock(0x80000000), _SessionIP(0), _SessionPort(0), _SessionIPStr{ 0 }, _IOCounts(0x80000000), _IOFlag(0), _TimeOutTimer(0)
        {

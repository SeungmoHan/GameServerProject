...
namespace univ_dev
{
	...
	void MonitoringServer::UpdateHardwareData()
	{
		...
		this->_H_NonpagedMemory[this->MAX] = max(this->_H_NonpagedMemory[this->MAX], nonpagedMemory);
		this->_H_NonpagedMemory[this->MIN] = min(this->_H_NonpagedMemory[this->MIN], nonpagedMemory);

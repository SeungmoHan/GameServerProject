...
namespace univ_dev
{
	ProcessMonitor::ProcessMonitor(HANDLE process) : _Process{ process }, _ProcessTotal{ 0 }, _ProcessUser{ 0 }, _ProcessKernel{ 0 }, _ProcessLastKernel{ 0 }, _ProcessLastUser{ 0 }, _ProcessLastTime{ 0 }
	{
	...
	void ProcessMonitor::UpdateProcessTime()
	{
		ULARGE_INTEGER _;

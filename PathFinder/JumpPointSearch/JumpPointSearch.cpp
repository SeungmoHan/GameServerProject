...
namespace univ_dev
{
	...
	JumpPointSearch::PathNode* JumpPointSearch::GetShortestPath(JumpPointSearch::PathNode* nodeList, TileMap& tileMap)
	{
		...
		while (nextNode != nullptr)
		{
			...
			if (isConnected)
			{
				...
				{
					univ_dev::JumpPointSearch::PathNode* newNode = new univ_dev::JumpPointSearch::PathNode();
			...
			JumpPointSearch::PathNode* newNode = new univ_dev::JumpPointSearch::PathNode();
	...
	JumpPointSearch::PathNode* JumpPointSearch::FindPath(TileMap& OUT tileMap, int IN beginXPoint, int IN endXPoint, int IN beginYPoint, int IN endYPoint)
	{
		...
		while (!openList.empty())
		{
			...
			auto minIter = openList.begin();
			for (auto iter = openList.begin(); iter != openList.end(); ++iter)
			{
				if ((*minIter)->FValue > (*iter)->FValue)
					minIter = iter;
			}
